...
public struct ShimmerView: View {
    ...
    var gradient: LinearGradient {
        let leading = Gradient.Stop(color: Color.white.opacity(0.7), location: 0.35)
        let center = Gradient.Stop(color: Color.white.opacity(0.9), location: 0.45)
        let trailing = Gradient.Stop(color: Color.white.opacity(0.7), location: 0.55)
